    ...
    <div className="mx-auto max-w-7xl">
      <div className="flex flex-col lg:flex-row lg:justify-between mb-16">
        <div className="mb-12 lg:mb-0 lg:w-1/3">
          <p className="text-3xl font-black tracking-tighter leading-none text-(--lithos-text) uppercase">
            BRAND MARK
          </p>
        ...
        <div className="flex flex-wrap lg:w-2/3 lg:justify-end">
          <div className="w-1/2 sm:w-1/3 mb-8 sm:mb-0 lg:ml-12">
            <h4 className="font-black uppercase tracking-widest text-sm mb-6 text-(--lithos-text)">
              Product
            </h4>
            <ul className="flex flex-col space-y-4 font-bold">
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Features</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Pricing</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Changelog</a></li>
            </ul>
          </div>
          ...
          <div className="w-1/2 sm:w-1/3 mb-8 sm:mb-0 lg:ml-12">
            ...
            <ul className="flex flex-col space-y-4 font-bold">
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Documentation</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">API Reference</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Community</a></li>
            </ul>
          </div>
          ...
          <div className="w-1/2 sm:w-1/3 lg:ml-12">
            ...
            <ul className="flex flex-col space-y-4 font-bold">
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">About</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Blog</a></li>
              <li><a href="#" className="hover:text-(--lithos-accent) transition-colors">Careers</a></li>
            </ul>
          </div>
        </div>
      </div>
