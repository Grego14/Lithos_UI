...
export const THEME_PROPERTIES: ThemeProperty[] = [
  ...
  { key: '--lithos-shadow-color', label: 'Shadow color', section: 'shadow', type: 'color' },
  {
    key: '--lithos-shadow-opacity',
...
export const LIGHT_DEFAULTS: Record<string, string> = {
  ...
  '--lithos-shadow-color': '#000000',
  '--lithos-shadow-opacity': '100%',
  '--lithos-shadow-offset': '4px',
  '--lithos-radius': '0px',
}
