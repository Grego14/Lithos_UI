...
const tocRegistry: Record<string, TOCItem[]> = {
  ...
  '/docs/dialog': [
    ...
    { id: '#scrollable', label: 'Scrollable content, sticky footer', level: 2 },
    { id: '#no-close', label: 'No close icon', level: 2 },
    { id: '#convenience', label: 'Convenience Components', level: 1 },
    { id: '#alert-dialog', label: 'AlertDialog', level: 2 },
    { id: '#confirm-dialog', label: 'ConfirmDialog', level: 2 },
    { id: '#accessibility', label: 'Accessibility', level: 1 },
    { id: '#api', label: 'API Reference', level: 1 },
  ],
  '/docs/toggle': [
