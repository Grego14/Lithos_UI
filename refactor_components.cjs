...
replaceRegexInFile(
  path.join(srcDir, 'components/ui/Breadcrumb.tsx'),
  /variant\?: 'collapsible' \| 'icon'/g,
  "mode?: 'collapsible'\n  showIcons?: boolean"
)
replaceRegexInFile(
  path.join(srcDir, 'components/ui/Breadcrumb.tsx'),
  /variant = 'collapsible',/g,
  "mode = 'collapsible',\n  showIcons = false,"
)
...
;[
  ...
  'Card.tsx',
  'Toast.tsx',
  'carousel/CarouselButton.tsx',
  'Calendar.tsx',
  'carousel/CarouselPagination.tsx',
  'carousel/CarouselControls.tsx',
].forEach((file) => {
